...
public class OpenAiService {
    ...
    public String generateCarDescriptionWithPlate(String plate) {
        Car car = carRepository.findCarByPlate(plate)
                .orElseThrow(() -> new BaseException(new ErrorMessage(MessageType.OBJECT_NOT_FOUND, plate)));
        ...
        String prompt = String.format("""
                Act as a professional car dealership copywriter.
                        ...
                        4. Dont add any contact information.
    ...
    public String aiSalesConsultant(String query) {
        List<DtoCar> response = vectorService.vectorSearch(query);
        if (response == null) {
            return "I cant find any car";
        }
        String carContext = null; // String.join("\n", response);
